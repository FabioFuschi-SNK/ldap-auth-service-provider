...
use Zend\Ldap\Ldap;
use snk\Silex\LdapAuth\Security\Core\Authentication\Provider\LdapAuthenticationProvider;
use snk\Silex\LdapAuth\Security\Core\User\LdapUserProvider;
